# [ESWA] Continual Test-Time Adaptation for Object Detection with Adaptive Monitoring and Randomized Restoration
...
If you use AMROD in your research or wish to refer to the baseline results, please use the following BibTeX entry.

```BibTeX
@article{cao2026continual,
  title={Continual Test-Time Adaptation for Object Detection with Adaptive Monitoring and Randomized Restoration},
  author={Cao, Shilei and Zheng, Juepeng and Liu, Yan and Zhao, Baoquan and Yuan, Ziqi and Li, Weijia and Dong, Runmin and Fu, Haohuan},
