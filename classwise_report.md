...
Generated 2026-09-19 12:37 by `scripts/classwise_analysis.py` from the run logs. Do not edit by hand - regenerate.
...
| ACDC long-term | SEG | `e29_segonly_acdc_acdcLT_s0` | 0 | 40 | seg only |
...
| road | SEG | 64.75 | 60.13 | 67.76 (R10) | 67.76 | +0.00 |
...
| sidewalk | SEG | 30.10 | 28.88 | 30.57 (R8) | 30.24 | -0.33 |
...
| building | SEG | 63.82 | 62.32 | 64.47 (R5) | 63.28 | -1.19 |
...
| wall | SEG | 10.35 | 9.86 | 10.57 (R6) | 10.04 | -0.53 |
...
| fence | SEG | 13.89 | 11.90 | 14.59 (R9) | 14.50 | -0.08 |
...
| pole | SEG | 35.49 | 33.60 | 36.06 (R5) | 35.53 | -0.54 |
...
| traffic light | SEG | 37.80 | 35.69 | 38.40 (R5) | 38.28 | -0.11 |
...
| traffic sign | SEG | 41.27 | 39.60 | 41.76 (R5) | 41.33 | -0.43 |
...
| vegetation | SEG | 54.29 | 53.71 | 54.52 (R6) | 54.29 | -0.23 |
...
| terrain | SEG | 21.82 | 20.27 | 22.98 (R10) | 22.98 | +0.00 |
...
| sky | SEG | 66.84 | 63.73 | 68.80 (R10) | 68.80 | +0.00 |
...
| person | SEG | 33.38 | 28.28 | 36.62 (R10) | 36.62 | +0.00 |
...
| rider | SEG | 36.36 | 35.65 | 36.95 (R10) | 36.95 | +0.00 |
...
| car | SEG | 68.33 | 63.73 | 70.28 (R10) | 70.28 | +0.00 |
...
| truck | SEG | 16.54 | 13.03 | 18.26 (R10) | 18.26 | +0.00 |
...
| bus | SEG | 13.57 | 11.61 | 14.90 (R8) | 14.61 | -0.29 |
...
| train | SEG | 28.97 | 22.33 | 31.61 (R10) | 31.61 | +0.00 |
...
| motorcycle | SEG | 20.39 | 16.84 | 22.42 (R10) | 22.42 | +0.00 |
...
| bicycle | SEG | 34.36 | 28.68 | 36.09 (R7) | 35.74 | -0.35 |
...
| Class | Source | d_SEG | d_DET | d_SEG&#124;DET | d_DET&#124;SEG | I_c |
|---|---|---|---|---|---|---|
| person | 24.60 | &mdash; | +5.87 | +1.09 | &mdash; | &mdash; |
| rider | 20.08 | &mdash; | +6.96 | +0.94 | &mdash; | &mdash; |
| car | 43.49 | &mdash; | +7.55 | +0.69 | &mdash; | &mdash; |
| truck | 16.16 | &mdash; | +4.07 | -1.84 | &mdash; | &mdash; |
| bus | 17.16 | &mdash; | +4.61 | +1.71 | &mdash; | &mdash; |
| train | 13.33 | &mdash; | +3.32 | -2.29 | &mdash; | &mdash; |
| motorcycle | 11.81 | &mdash; | +6.67 | +1.15 | &mdash; | &mdash; |
| bicycle | 13.59 | &mdash; | +8.02 | +0.30 | &mdash; | &mdash; |

#### Difficulty vs harmfulness, AP

| Relationship | Spearman rho |
|---|---|
| source score vs I_c | &mdash; |
| full-MTL drift vs I_c | &mdash; |
...
| Class | Source | d_SEG | d_DET | d_SEG&#124;DET | d_DET&#124;SEG | I_c |
|---|---|---|---|---|---|---|
| road | 58.23 | +6.51 | +12.94 | -1.64 | +4.79 | -8.15 **(neg)** |
| sidewalk | 28.14 | +1.96 | +3.83 | +4.29 | +6.16 | +2.33 |
| building | 59.93 | +3.89 | +7.77 | +0.02 | +3.90 | -3.87 **(neg)** |
| wall | 9.11 | +1.24 | +4.10 | +2.62 | +5.48 | +1.38 |
| fence | 11.09 | +2.80 | +4.48 | -2.66 | -0.99 | -5.46 **(neg)** |
| pole | 32.44 | +3.05 | +1.44 | +3.13 | +1.51 | +0.08 |
| traffic light | 34.38 | +3.42 | +2.05 | +8.26 | +6.88 | +4.83 |
| traffic sign | 38.42 | +2.85 | +5.16 | +1.45 | +3.77 | -1.40 **(neg)** |
| vegetation | 52.30 | +1.99 | +11.84 | -3.77 | +6.08 | -5.76 **(neg)** |
| terrain | 20.12 | +1.70 | +1.54 | +1.74 | +1.58 | +0.04 |
| sky | 60.42 | +6.42 | +10.32 | -2.43 | +1.46 | -8.85 **(neg)** |
| person | 25.68 | +7.70 | +12.96 | -4.22 | +1.04 | -11.93 **(neg)** |
| rider | 34.91 | +1.45 | +7.81 | +0.09 | +6.44 | -1.37 **(neg)** |
| car | 62.10 | +6.23 | +8.67 | -6.44 | -4.00 | -12.67 **(neg)** |
| truck | 11.85 | +4.69 | +5.27 | -1.03 | -0.45 | -5.72 **(neg)** |
| bus | 11.16 | +2.41 | +3.24 | +0.37 | +1.21 | -2.04 **(neg)** |
| train | 19.36 | +9.62 | +10.22 | +6.02 | +6.62 | -3.60 **(neg)** |
| motorcycle | 15.72 | +4.67 | +7.30 | +6.08 | +8.71 | +1.41 |
| bicycle | 26.47 | +7.89 | +5.39 | +6.19 | +3.68 | -1.70 **(neg)** |

#### Thing classes (mapped to detection) vs stuff classes

| Group | n | mean I_c | mean d_SEG&#124;DET | n with I_c<0 |
|---|---|---|---|---|
| thing (mapped) | 8 | -4.70 | +0.88 | 7/8 |
| stuff (seg-only) | 11 | -2.26 | +1.00 | 6/11 |

#### Difficulty vs harmfulness, IoU

| Relationship | Spearman rho |
|---|---|
| source score vs I_c | -0.36 |
| full-MTL drift vs I_c | 0.33 |
...
|---|---|---|---|
| person | &mdash; | -1.20 | &mdash; |
| rider | &mdash; | -2.78 | &mdash; |
| car | &mdash; | -1.36 | &mdash; |
| truck | &mdash; | -1.76 | &mdash; |
| bus | &mdash; | -6.98 | &mdash; |
| train | &mdash; | -3.73 | &mdash; |
| motorcycle | &mdash; | -1.29 | &mdash; |
| bicycle | &mdash; | -1.02 | &mdash; |

### IoU

| Class | I_c ACDC | I_c CSC | verdict |
|---|---|---|---|
| road | -8.15 | -3.45 | harmful on both |
| sidewalk | +2.33 | -2.95 | **flips: helps on ACDC, harms on CSC** |
| building | -3.87 | -6.46 | harmful on both |
| wall | +1.38 | -3.17 | **flips: helps on ACDC, harms on CSC** |
| fence | -5.46 | +0.48 | flips the other way |
| pole | +0.08 | -7.32 | **flips: helps on ACDC, harms on CSC** |
| traffic light | +4.83 | -5.22 | **flips: helps on ACDC, harms on CSC** |
| traffic sign | -1.40 | +4.39 | flips the other way |
| vegetation | -5.76 | -14.08 | harmful on both |
| terrain | +0.04 | -3.69 | **flips: helps on ACDC, harms on CSC** |
| sky | -8.85 | -1.62 | harmful on both |
| person | -11.93 | -10.11 | harmful on both |
| rider | -1.37 | -8.99 | harmful on both |
| car | -12.67 | -4.74 | harmful on both |
| truck | -5.72 | -7.48 | harmful on both |
| bus | -2.04 | -16.81 | harmful on both |
| train | -3.60 | -7.80 | harmful on both |
| motorcycle | +1.41 | -6.13 | **flips: helps on ACDC, harms on CSC** |
| bicycle | -1.70 | -2.75 | harmful on both |
